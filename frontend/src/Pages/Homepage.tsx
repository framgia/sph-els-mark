...
<div className="bg-white dark:bg-gray-900 mt-[12rem]">
    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
        <h1 className="mb-6 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">E - Learning System</h1>
        <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400">Education has never been more exciting, more engaging, or more accessible than it is here. Discover your potential and unlock new horizons through our E-Learning System.</p>
