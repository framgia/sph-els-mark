...
const Follow:React.FC<FollowProps > = ({
  ...
  return (
    ...
    <div className=" mt-9  border-b-2 border-gray-500 pb-[1rem] w-[240px] text-center">
      ...
      className="bg-blue-500  text-white px-[4rem] ml-5 py-2 rounded-[5rem] mt-5">{follow? 'Unfollow' : 'Follow'}</button>

      <p className="py-4 px-6 text-blue-500 underline ml-5">Learned 120 words</p>
  </div>
  </>
  )
}
